...
import (
	...
	"github.com/luoshang722/qtumutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    qtumutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() qtumutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value qtumutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = qtumutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = qtumutil.NewTxFromBytes(testSimpleCoinTxBytes)
